    ...
    function contador() {
        ...
        if ( tiem == 3) {
            ...
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[0] == i) {
                    i--;
                    document.getElementById('n1').setAttribute("title",nombre[i]);
                    break;
                }
            }
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[1] == i) { 
                    i--;
                    document.getElementById('n2').setAttribute("title",nombre[i]);
                    break;
                }
            }
        }
        if ( tiem == 5) {
            ...
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[2] == i) { 
                    i--;
                    document.getElementById('n3').setAttribute("title",nombre[i]);
                    break;
                }
            }
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[3] == i) { 
                    i--;
                    document.getElementById('n4').setAttribute("title",nombre[i]);
                    break;
                }
            }
        }
        if ( tiem == 7) {
            ...
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[4] == i) { 
                    i--;
                    document.getElementById('n5').setAttribute("title",nombre[i]);
                    break;
                }
            }
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[5] == i) { 
                    i--;
                    document.getElementById('n6').setAttribute("title",nombre[i]);
                    break;
                }
            }
        }
        if ( tiem == 9) {
            ...
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[6] == i) { 
                    i--;
                    document.getElementById('n7').setAttribute("title",nombre[i]);
                    break;
                }
            }
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[7] == i) { 
                    i--;
                    document.getElementById('n8').setAttribute("title",nombre[i]);
                    break;
                }
            }
        }
        if ( tiem == 11) {
            ...
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[8] == i) { 
                    i--;
                    document.getElementById('n9').setAttribute("title",nombre[i]);
                    break;
                }
            }
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[9] == i) { 
                    i--;
                    document.getElementById('n10').setAttribute("title",nombre[i]);
                    break;
                }
            }
        }
        if ( tiem == 13) {
            ...
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[10] == i) { 
                    i--;
                    document.getElementById('n11').setAttribute("title",nombre[i]);
                    break;
                }
            }
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[11] == i) { 
                    i--;
                    document.getElementById('n12').setAttribute("title",nombre[i]);
                    break;
                }
            }
        }
        if ( tiem == 15) {
            ...
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[12] == i) { 
                    i--;
                    document.getElementById('n13').setAttribute("title",nombre[i]);
                    break;
                }
            }
            for (var i = 1 ; i <= 15 ; i++) {
                if (parreja[13] == i) { 
                    i--;
                    document.getElementById('n14').setAttribute("title",nombre[i]);
                    break;
                }
            }
        }
